        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 12 }}>
          <div className="checklist-item">
            ...
            <div className="checklist-body">
              ...
              <div style={{ marginTop: '8px', fontSize: '0.8rem', color: '#94a3b8', background: 'rgba(255,255,255,0.05)', padding: '6px 8px', borderRadius: '4px', fontFamily: 'monospace' }}>
                <strong style={{ color: '#bae6fd' }}>Step 1:</strong> Base Cosine Similarity = {metrics.f1_cosine}/100<br />
          ...
          <div className="checklist-item">
            ...
            <div className="checklist-body">
              ...
              <div style={{ marginTop: '8px', fontSize: '0.8rem', color: '#94a3b8', background: 'rgba(255,255,255,0.05)', padding: '6px 8px', borderRadius: '4px', fontFamily: 'monospace' }}>
                <strong style={{ color: '#bae6fd' }}>Step 1:</strong> (Matched Words / JD Words) * 1.5 multiplier<br />
                <strong style={{ color: '#bae6fd' }}>Step 2:</strong> Base Keyword Density = {metrics.f2_keyword}/100<br />
                <strong style={{ color: '#bae6fd' }}>Step 3:</strong> Apply 20% Weight: {metrics.f2_keyword} * 0.20 = <strong style={{ color: '#fff' }}>{metrics.f2_weight_20} pts</strong>
              </div>
            </div>
          </div>
          ...
          <div className="checklist-item">
            ...
            <div className="checklist-body">
              ...
              <div style={{ marginTop: '8px', fontSize: '0.8rem', color: '#94a3b8', background: 'rgba(255,255,255,0.05)', padding: '6px 8px', borderRadius: '4px', fontFamily: 'monospace' }}>
                <strong style={{ color: '#bae6fd' }}>Step 1:</strong> Avg(Tech Match {metrics.technical_skills_match}% + Soft Match {metrics.soft_skills_match}%) = {metrics.f3_skill}<br />
